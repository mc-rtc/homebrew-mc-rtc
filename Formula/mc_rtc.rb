class McRtc < Formula
  ...
  bottle do
    root_url "https://github.com/mc-rtc/homebrew-mc-rtc/releases/download/mc_rtc-2.5.0"
    sha256 x86_64_linux: "b4b72946520c6cdd129591764cd544b77f8f22edef2bde743070d6c6e1fbdee3"
  end
