class Tasks < Formula
  ...
  bottle do
    root_url "https://github.com/mc-rtc/homebrew-mc-rtc/releases/download/tasks-1.7.0"
    sha256 cellar: :any_skip_relocation, x86_64_linux: "996bc0544bbedfdfba62f92f960c9558fc8cea20cdd516b38d4f80bfbfdc336e"
  end
